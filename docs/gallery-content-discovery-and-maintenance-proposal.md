...
- `AzureCosmosDB/gallery` is read-only. Automation runs only in `jaydestro/gallery`.
...
- Copilot model choice and monthly AI-credit budget.
- Whether additional discovery sources should receive reviewed catalog defaults and become eligible for promotion.
